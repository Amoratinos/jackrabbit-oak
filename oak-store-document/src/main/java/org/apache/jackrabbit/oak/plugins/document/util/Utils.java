...
public class Utils {
    ...
    public static Iterable<StringValue> asStringValueIterable(
        ...
        return CollectionUtils.toStream(values).map(input -> new StringValue(input)).collect(Collectors.toList());
    }
    ...
    public static Iterable<String> pathToId(@NotNull Iterable<String> paths) {
        return CollectionUtils.toStream(paths).map(input -> getIdFromPath(input)).collect(Collectors.toList());
    }
